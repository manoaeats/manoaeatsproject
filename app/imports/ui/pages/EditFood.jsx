  ...
  renderPage() {
    return (
        <Grid container centered>
          <Grid.Column>
            <Header as="h2" textAlign="center" inverted>Edit Food</Header>
...
export default withTracker(({ match }) => {
  ...
  const subscription2 = Meteor.subscribe(Foods.vendorPublicationName);
  return {
    doc: Foods.collection.findOne(documentId),
